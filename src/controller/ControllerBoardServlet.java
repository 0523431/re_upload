...
//.do 요청이들어오면 나를 호출해
@WebServlet(urlPatterns= {"*.bo"}, initParams= {@WebInitParam(name="properties", value="board.properties")})

public class ControllerBoardServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Method method = BoardAction.class.getMethod(methodName, paramType);
			// invoke : 메서드 호출 기능
