...
<table>
	<tr>
		...
		<td class="sub" width="30%">
			...
			<input type="radio" name="type1" value="3" ${info.type1==3? "checked":"" }>무료&nbsp;&nbsp;
		</td>
...
<table>
	<tr>
		...
		<td colspan="2" class="sub" width="60%">
			...
			<input type="radio" name="type2" value="6" ${info.type2==6? "checked":"" }>기념품&nbsp;&nbsp;
	...
	<tr>
		...
		<td class="sub">
			<select name="seldate" id="seldate" onchange="selectdate(this)">
				<c:forEach var="date" begin="${fn:substring(info_period.start,3,5)}" end="${fn:substring(info_period.end,3,5)}" >
...
<!-- 수정 완료 / 취소 -->
<div class="divcenter">
	<button onclick="return goback()">취소</button>&nbsp;&nbsp;&nbsp;
	<button onclick="return checkToSave()">완료</button>
</div>
